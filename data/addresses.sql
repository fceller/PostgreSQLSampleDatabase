...
--
-- Data for Name: addresses; Type: TABLE DATA; Schema: webshop; Owner: postgres
--

COPY webshop.addresses (id, customer_id, firstname, lastname, address_line_1, address_line_2, city, zip, created, updated) FROM stdin;
...
--
-- Name: addresses_id_seq; Type: SEQUENCE SET; Schema: webshop; Owner: postgres
--

SELECT pg_catalog.setval('webshop.addresses_id_seq', 1132, true);
